...
3. **AI classification** — [AI Classification](../features/ai-classification.md) detects [Type](../domain/type.md), [Color](../domain/color.md), and [Brand](../domain/brand.md), and suggests [Collections](../domain/collection.md). [Category](../domain/category.md) is derived from the detected type.
