...
**"What do I have?"** — When users want to create something new, the [wardrobe](./features/wardrobe-filtering.md) acts as a visual browser of everything they own. Quick scanning and filtering by category, type, color, brand, or collections lets users see what is available and find combinations they haven't tried.
...
- **Filtering** — find items by [Category](./domain/category.md), [Type](./domain/type.md), [Color](./domain/color.md), [Brand](./domain/brand.md), and [Collections](./domain/collection.md) to quickly browse what you have.
